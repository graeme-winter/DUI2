...
def get_data_from_steps(uni_cmd, cmd_dict, step_list):
    ...
    if uni_cmd == ["display_log"]:
        for lin2go in cmd_dict["nod_lst"]:
            try:
                lof_file = open(step_list[lin2go].log_file_path, "r")
        ...
        for lin2go in cmd_dict["nod_lst"]:
            try:
                print(
                    "generating image JSON data for line:",
                    lin2go,
                    " image:",
                    int(uni_cmd[1]),
                )
                ...
                str_json = flex_arr_2_json.get_json_w_img_2d(
                    step_list[lin2go]._lst_expt_out, int(uni_cmd[1])
                )
        ...
        for lin2go in cmd_dict["nod_lst"]:
            try:
                print(
                    "generating slice of image for line:",
                    lin2go,
                    " image:",
                    int(uni_cmd[1]),
                    "\n uni_cmd =",
        ...
        for lin2go in cmd_dict["nod_lst"]:
            try:
                print(
                    "generating mask image JSON data for line:",
                    lin2go,
                    " image:",
                    int(uni_cmd[1]),
                )
        ...
        for lin2go in cmd_dict["nod_lst"]:
            try:
                print(
                    "generating slice of mask image for line:",
                    lin2go,
                    " image:",
                    int(uni_cmd[1]),
                    "\n uni_cmd =",
        ...
        for lin2go in cmd_dict["nod_lst"]:
            try:
                print(
                    "generating reflection list for line:",
                    lin2go,
                    " image:",
                    int(uni_cmd[1]),
                )
        ...
        for lin2go in cmd_dict["nod_lst"]:
            try:
                img_num = int(uni_cmd[1])
                print("generating predictions for line:", lin2go, " image:", img_num)
                sub_par = uni_cmd[2]
...
def iter_dict(file_path, depth_ini):
    ...
    local_dict = {"file_name": file_name, "file_path": file_path, "list_child": []}
    if depth_ini >= 30:
